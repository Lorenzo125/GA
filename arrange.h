...
void arrange(){
  ...
  for (i=0;i<nchrom;i++){ //cerco i crom con costo minore tra i seguenti, prendo il minimo e lo metto nella prima riga, quello che era nella prima riga lo metto al posto del crom con costo minimo
    tmin=i;
